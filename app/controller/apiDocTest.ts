 ...
 * Define blocks with params that will be used in severalexport functions, so you dont have to rewrite them.
 *
 ...
 * @apiPermission none
 *
 * @apiDescription Thisexport function has same errors like POST /user, but errors not defined again, they were included with "apiErrorStructure"
 *
